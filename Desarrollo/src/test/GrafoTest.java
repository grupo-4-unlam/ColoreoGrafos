...
public class GrafoTest {
	...
	private static final String PATH_ARCHIVOS_SAL = "C:/Programacion-avanzada-TPs/TP4/lotesDePrueba/OUT/";
	
	@Test
	public void pruebaDeColoreoAleatorioSecuencialUno(){
		GrafoNDNP grafoUno = new GrafoNDNP(PATH_ARCHIVOS_ENT + "grafoRegular5N.in");
	...
	public void pruebaDeColoreoAleatorioSecuencialDos(){
		GrafoNDNP grafoDos = new GrafoNDNP(PATH_ARCHIVOS_ENT + "grafo6N.in");
	...
	public void pruebaDeColoreoWelshPowell(){
		GrafoNDNP grafoTres = new GrafoNDNP(PATH_ARCHIVOS_ENT + "grafo7N.in");
	...
	public void pruebaColoreo600y40(){
		GrafoNDNP grafoTres = new GrafoNDNP(PATH_ARCHIVOS_ENT + "grafo600y40.in");
		grafoTres.colorearPowell();
	...
	public void pruebaColoreo600y60(){
		GrafoNDNP grafoTres = new GrafoNDNP(PATH_ARCHIVOS_ENT + "grafo600y60.in");
		grafoTres.colorearPowell();
	...
	public void pruebaColoreo600y90(){
		GrafoNDNP grafoTres = new GrafoNDNP(PATH_ARCHIVOS_ENT + "grafo600y90.in");
		grafoTres.colorearPowell();
	...
	public void pruebaColoreo1000y50(){
		GrafoNDNP grafoTres = new GrafoNDNP(PATH_ARCHIVOS_ENT + "grafoRegular1000y50.in");
		grafoTres.colorearPowell();
	...
	public void pruebaColoreo1000y75(){
		GrafoNDNP grafoTres = new GrafoNDNP(PATH_ARCHIVOS_ENT + "grafoRegular1000y75.in");
		grafoTres.colorearPowell();
	...
	public void pruebaColoreoNPartito800y400() {
		GrafoNDNP grafo = new GrafoNDNP(PATH_ARCHIVOS_ENT + "grafoNPartito800y400.in");
	...
	public void pruebaColoreoNPartito100y50() {
		GrafoNDNP grafo = new GrafoNDNP(PATH_ARCHIVOS_ENT + "grafoNPartito100y50.in");
		grafo.colorearPowell();
